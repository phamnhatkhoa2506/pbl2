...
CREATE TABLE `food_combos` (
  ...
  `combos_id` varchar(255) NOT NULL,
  KEY `FKixqstw67r08x5frrft9nugfii` (`combos_id`),
  KEY `FKq5dymi7j3t37yn76qxnam7ggm` (`food_id`),
  CONSTRAINT `FKixqstw67r08x5frrft9nugfii` FOREIGN KEY (`combos_id`) REFERENCES `combo` (`id`),
  CONSTRAINT `FKq5dymi7j3t37yn76qxnam7ggm` FOREIGN KEY (`food_id`) REFERENCES `food` (`id`)
