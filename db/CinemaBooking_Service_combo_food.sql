...
CREATE TABLE `combo_food` (
  ...
  KEY `FKqimupi044r4e6pcictg5ll7n3` (`food_id`),
  CONSTRAINT `FKqimupi044r4e6pcictg5ll7n3` FOREIGN KEY (`food_id`) REFERENCES `food` (`id`),
  CONSTRAINT `FKqvda82atmpu85uhlpnpyocw44` FOREIGN KEY (`combo_id`) REFERENCES `combo` (`id`)
